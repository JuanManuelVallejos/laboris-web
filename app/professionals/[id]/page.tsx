...
export default async function ProfessionalPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-cream">
      ...
      <main className="flex-1 px-4 pt-5 pb-32 max-w-lg mx-auto w-full space-y-4">
      ...
      {/* CTA fijo */}
      <div className="fixed bottom-16 left-0 right-0 px-4 pb-2 bg-gradient-to-t from-cream via-cream/90 to-transparent pt-4">
